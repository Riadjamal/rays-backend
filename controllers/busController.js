...
exports.createBus = async (req, res, next) => {
  try {
    const { busNumber, name, capacity, seatLayout, route, driver, price, departureTime, startTime, isDaily, operatingDates } = req.body;
...
exports.updateBus = async (req, res, next) => {
  try {
    const { busNumber, name, capacity, seatLayout, route, driver, isActive, price, departureTime, startTime, isDaily, operatingDates } = req.body;
    ...
    if (isDaily !== undefined) bus.isDaily = isDaily;
    if (operatingDates) bus.operatingDates = operatingDates;
